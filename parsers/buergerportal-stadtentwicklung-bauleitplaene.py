...
def parse():
    ...
    fg = FeedGenerator()
    fg.id(url)
    fg.title('Bürgerportal - Stadtentwicklung - Bauleitpläne')
    fg.link(href=url, rel='self')
    fg.language('de')
    fg.description('Bauleitpläne der Stadtentwicklung')
    ...
    fg.rss_file(rss_path / 'buergerportal-stadtentwicklung-bauleitplaene.xml')
